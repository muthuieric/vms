    ...
    <div className="container">
      <Modal {...props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">Fill In Employee Information</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Row>
            <Col sm={6}>
              <Form onSubmit={handleSubmit}>
                ...
                <Form.Group controlId="Job_title">
                  ...
                  <Form.Control type="text" name="Job_title" required placeholder="" />
                </Form.Group>
                <Form.Group controlId="Id_number">
                  <Form.Label>ID Number</Form.Label>
                  <Form.Control type="text" name="Id_number" required placeholder="" />
                </Form.Group>
