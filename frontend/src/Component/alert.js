...
const Alert = (props) => {
  ...
  return (
    <div className={`container mx-auto mt-6 ${classAlert}`}>
      <div className="relative px-4 py-3 leading-normal text-white bg-blue-600 rounded-lg shadow-md" role="alert">
        <div className="flex items-center">   
          <div className="ml-3">
            <p className="text-sm font-medium">{props.message}</p>
          </div>
          <div className="absolute top-0 bottom-0 right-0 px-4 py-3">
            <svg onClick={handleClose} className="w-5 h-5 text-white cursor-pointer" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
